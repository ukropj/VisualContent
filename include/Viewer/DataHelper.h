...
public:
	 ...
	 * \deprecated
	 **/
	//static void generateCube(std::vector<Model::Node*> *nodes,std::vector<Model::Edge*> *edges,std::vector<Model::Type*> *types);

	/**
	 * \brief Vygeneruje jednoduhcy graf - Kocku
	 *
	 **/
	//static void generateCube2(std::vector<Model::Node*> *nodes,std::vector<Model::Edge*> *edges,std::vector<Model::Type*> *types);

	/**
	 * \brief Vygeneruje jednoduhcy graf - Stvorsten
	 *
	 **/
	//static void generatePyramid(std::vector<Model::Node*> *nodes,std::vector<Model::Edge*> *edges,std::vector<Model::Type*> *types);
	 ...
	 * \deprecated
	 **/
	//static void generateMultiCube(std::vector<Model::Node*> *nodes,std::vector<Model::Edge*> *edges,std::vector<Model::Type*> *types);
	...
	static void generateCylinder(
			QMap<qlonglong, osg::ref_ptr<Model::Node> > *nodes, QMap<qlonglong,
					osg::ref_ptr<Model::Edge> > *edges, QMap<qlonglong,
					Model::Type*> *types, int pocetUzlovNaPodstave,
			int pocetUzlovNaVysku);

	/**
	 * \brief Vygeneruje testovaciu scenu pozostavajucu z niekolkych samostatnych grafov
	 *
	 **/
	//static void generateTestingGraph(std::vector<Model::Node*> *nodes,std::vector<Model::Edge*> *edges,std::vector<Model::Type*> *types);
	/**
	...
	static osg::ref_ptr<osg::Vec3Array>
			getEdgeVectors(osg::ref_ptr<Model::Node> inNode, osg::ref_ptr<
					Model::Node> outNode);
	/**
